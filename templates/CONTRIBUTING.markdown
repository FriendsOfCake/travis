...
PLUGIN_NAME loves to welcome your contributions. There are several ways to help out:
...
* Contribute to the [documentation](https://github.com/GITHUB_USERNAME/REPO_NAME/tree/gh-pages)
...
PLUGIN_NAME tests requires [PHPUnit](http://www.phpunit.de/manual/current/en/installation.html)
3.5 or higher. To run the testcases locally use the following command:

    ./lib/Cake/Console/cake test PLUGIN_NAME AllPLUGIN_NAME

To run the sniffs for CakePHP coding standards

    phpcs -p --extensions=php --standard=CakePHP ./app/Plugin/PLUGIN_NAME
